                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              buildTeamMember('Jannalyn Cruz', 'UI/UX Developer / Systems Analyst & Quality Assurance', Icons.schema),
                              Divider(height: 32, color: borderColor),
                              buildTeamMember('Klent Charlo Obsioma', 'UI/UX Developer / Documentation', Icons.storage),
                            ],
                          ),
                        ),
                      ],
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 24),
                              buildStackCategory('Database', [buildChip('MySQL', Colors.green), buildChip('Docker', Colors.teal)]),
                              const SizedBox(height: 24),
